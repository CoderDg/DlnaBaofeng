...
public class Device implements org.cybergarage.http.HTTPRequestListener, SearchListener {
    ...
    /**
     * @param inets The IP that will be used for binding the SSDP service. Use
     ...
     * ps.println("presentationURL = " + getPresentationURL()); DeviceList
     * devList = getDeviceList(); ps.println("devList = " + devList.size());
     * ServiceList serviceList = getServiceList(); ps.println("serviceList = " +
     * serviceList.size()); IconList iconList = getIconList();
     * ps.println("iconList = " + iconList.size()); } public void print() {
     * PrintWriter pr = new PrintWriter(System.out); output(pr); pr.flush(); }
     */
